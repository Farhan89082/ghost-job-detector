...
### 1. Clone
```bash
git clone https://github.com/Farhan89082/ghost-job-detector.git
...
Open http://localhost:5000 in your browser. Click **"Try Demo Data"** to explore the UI without a backend running.
...
│       └── sample_jobs.csv
├── docs/
│   ├── Screenshot Front page 1.png
│   ├── Screenshot Front page 2.png
│   └── Screenshot Front page 3.png
├── tests/
│   └── test_detector.py
└── README.md
```
